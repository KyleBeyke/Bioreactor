...
def maintain_temperature():
    """Controls the heater based on the target temperature."""
...
def control_loop():
    ...
    asyncio.create_task(heater.zero_cross_task())
    maintain_temperature_task = asyncio.create_task(maintain_temperature())
    recalibrate_at_target_temp()
