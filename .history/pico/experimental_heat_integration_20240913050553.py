...
# Initialize I2C devices and sensors
...
# Temperature control function (Async) with frequent temperature queries
async def maintain_temperature():
    """Asynchronously controls the heater based on the target temperature with more frequent temperature checks."""
